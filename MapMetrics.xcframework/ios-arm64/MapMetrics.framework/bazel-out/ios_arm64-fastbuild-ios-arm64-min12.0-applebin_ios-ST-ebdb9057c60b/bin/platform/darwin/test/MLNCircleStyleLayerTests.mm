...
@interface MLNCircleLayerTests : MLNStyleLayerTests
@end

@implementation MLNCircleLayerTests
...
- (void)testPredicates {
    ...
    MLNCircleStyleLayer *layer = [[MLNCircleStyleLayer alloc] initWithIdentifier:@"layerID" source:source];
...
- (void)testProperties {
    ...
    // circle-blur
    {
        ...
        MLNTransition circleBlurTransition = layer.circleBlurTransition;
    ...
    // circle-color
    {
        ...
        MLNTransition circleColorTransition = layer.circleColorTransition;
    ...
    // circle-opacity
    {
        ...
        MLNTransition circleOpacityTransition = layer.circleOpacityTransition;
    ...
    // circle-pitch-alignment
    {
        ...
        XCTAssertThrowsSpecificNamed(layer.circlePitchAlignment = functionExpression, NSException, NSInvalidArgumentException, @"MLNCircleLayer should raise an exception if a camera-data expression is applied to a property that does not support key paths to feature attributes.");
    ...
    // circle-radius
    {
        ...
        MLNTransition circleRadiusTransition = layer.circleRadiusTransition;
    ...
    // circle-pitch-scale
    {
        ...
        functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
        XCTAssertThrowsSpecificNamed(layer.circleScaleAlignment = functionExpression, NSException, NSInvalidArgumentException, @"MLNCircleLayer should raise an exception if a camera-data expression is applied to a property that does not support key paths to feature attributes.");
        functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)", constantExpression, @{@18: constantExpression}];
        functionExpression = [NSExpression expressionWithFormat:@"mgl_interpolate:withCurveType:parameters:stops:($zoomLevel, 'linear', nil, %@)", @{@10: functionExpression}];
        XCTAssertThrowsSpecificNamed(layer.circleScaleAlignment = functionExpression, NSException, NSInvalidArgumentException, @"MLNCircleLayer should raise an exception if a camera-data expression is applied to a property that does not support key paths to feature attributes.");
    }
    ...
    // circle-stroke-color
    {
        ...
        MLNTransition circleStrokeColorTransition = layer.circleStrokeColorTransition;
    ...
    // circle-stroke-opacity
    {
        ...
        MLNTransition circleStrokeOpacityTransition = layer.circleStrokeOpacityTransition;
    ...
    // circle-stroke-width
    {
        ...
        MLNTransition circleStrokeWidthTransition = layer.circleStrokeWidthTransition;
    ...
    // circle-translate
    {
        ...
        functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
        XCTAssertThrowsSpecificNamed(layer.circleTranslation = functionExpression, NSException, NSInvalidArgumentException, @"MLNCircleLayer should raise an exception if a camera-data expression is applied to a property that does not support key paths to feature attributes.");
        functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)", constantExpression, @{@18: constantExpression}];
        functionExpression = [NSExpression expressionWithFormat:@"mgl_interpolate:withCurveType:parameters:stops:($zoomLevel, 'linear', nil, %@)", @{@10: functionExpression}];
        XCTAssertThrowsSpecificNamed(layer.circleTranslation = functionExpression, NSException, NSInvalidArgumentException, @"MLNCircleLayer should raise an exception if a camera-data expression is applied to a property that does not support key paths to feature attributes.");
    }
    ...
    // circle-translate-anchor
    {
        ...
        functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
        XCTAssertThrowsSpecificNamed(layer.circleTranslationAnchor = functionExpression, NSException, NSInvalidArgumentException, @"MLNCircleLayer should raise an exception if a camera-data expression is applied to a property that does not support key paths to feature attributes.");
        functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)", constantExpression, @{@18: constantExpression}];
        functionExpression = [NSExpression expressionWithFormat:@"mgl_interpolate:withCurveType:parameters:stops:($zoomLevel, 'linear', nil, %@)", @{@10: functionExpression}];
        XCTAssertThrowsSpecificNamed(layer.circleTranslationAnchor = functionExpression, NSException, NSInvalidArgumentException, @"MLNCircleLayer should raise an exception if a camera-data expression is applied to a property that does not support key paths to feature attributes.");
    }
...
- (void)testValueAdditions {
    XCTAssertEqual([NSValue valueWithMLNCirclePitchAlignment:MLNCirclePitchAlignmentMap].MLNCirclePitchAlignmentValue, MLNCirclePitchAlignmentMap);
    XCTAssertEqual([NSValue valueWithMLNCirclePitchAlignment:MLNCirclePitchAlignmentViewport].MLNCirclePitchAlignmentValue, MLNCirclePitchAlignmentViewport);
    XCTAssertEqual([NSValue valueWithMLNCircleScaleAlignment:MLNCircleScaleAlignmentMap].MLNCircleScaleAlignmentValue, MLNCircleScaleAlignmentMap);
    XCTAssertEqual([NSValue valueWithMLNCircleScaleAlignment:MLNCircleScaleAlignmentViewport].MLNCircleScaleAlignmentValue, MLNCircleScaleAlignmentViewport);
    XCTAssertEqual([NSValue valueWithMLNCircleTranslationAnchor:MLNCircleTranslationAnchorMap].MLNCircleTranslationAnchorValue, MLNCircleTranslationAnchorMap);
    XCTAssertEqual([NSValue valueWithMLNCircleTranslationAnchor:MLNCircleTranslationAnchorViewport].MLNCircleTranslationAnchorValue, MLNCircleTranslationAnchorViewport);
}

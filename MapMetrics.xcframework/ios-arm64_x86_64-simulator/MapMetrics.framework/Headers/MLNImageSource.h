...
/**
 ...
 Each
 <a href="https://mapmetrics.org/mapmetrics-style-spec/#sources-image"><code>image</code></a>
 ...
 "https://mapmetrics.org/mapmetrics-gl-js-docs/assets/radar.gif")!) mapView.style?.addSource(source)
 ```

...
@interface MLNFillExtrusionLayerTests : MLNStyleLayerTests
@end

@implementation MLNFillExtrusionLayerTests
...
- (void)testPredicates {
    ...
    MLNFillExtrusionStyleLayer *layer = [[MLNFillExtrusionStyleLayer alloc] initWithIdentifier:@"layerID" source:source];
...
- (void)testProperties {
    ...
    // fill-extrusion-base
    {
        ...
        MLNTransition fillExtrusionBaseTransition = layer.fillExtrusionBaseTransition;
    ...
    // fill-extrusion-color
    {
        ...
        MLNTransition fillExtrusionColorTransition = layer.fillExtrusionColorTransition;
    ...
    // fill-extrusion-vertical-gradient
    {
        ...
        XCTAssertThrowsSpecificNamed(layer.fillExtrusionHasVerticalGradient = functionExpression, NSException, NSInvalidArgumentException, @"MLNFillExtrusionLayer should raise an exception if a camera-data expression is applied to a property that does not support key paths to feature attributes.");
    ...
    // fill-extrusion-height
    {
        ...
        MLNTransition fillExtrusionHeightTransition = layer.fillExtrusionHeightTransition;
    ...
    // fill-extrusion-opacity
    {
        ...
        functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
        XCTAssertThrowsSpecificNamed(layer.fillExtrusionOpacity = functionExpression, NSException, NSInvalidArgumentException, @"MLNFillExtrusionLayer should raise an exception if a camera-data expression is applied to a property that does not support key paths to feature attributes.");
        functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)", constantExpression, @{@18: constantExpression}];
        functionExpression = [NSExpression expressionWithFormat:@"mgl_interpolate:withCurveType:parameters:stops:($zoomLevel, 'linear', nil, %@)", @{@10: functionExpression}];
        XCTAssertThrowsSpecificNamed(layer.fillExtrusionOpacity = functionExpression, NSException, NSInvalidArgumentException, @"MLNFillExtrusionLayer should raise an exception if a camera-data expression is applied to a property that does not support key paths to feature attributes.");
        // Transition property test
        ...
        MLNTransition fillExtrusionOpacityTransition = layer.fillExtrusionOpacityTransition;
    ...
    // fill-extrusion-pattern
    {
        ...
        constantExpression = [NSExpression expressionWithFormat:@"MLN_FUNCTION('image', 'Fill Extrusion Pattern')"];
        XCTExpectFailure(@"Awaiting unit test refactoring https://github.com/mapmetrics/mapmetrics-native/issues/421");
        NSExpression *functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:($zoomLevel, %@, %@)", constantExpression, @{@18: constantExpression}];
        ...
        MLNTransition fillExtrusionPatternTransition = layer.fillExtrusionPatternTransition;
    ...
    // fill-extrusion-translate
    {
        ...
        functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
        XCTAssertThrowsSpecificNamed(layer.fillExtrusionTranslation = functionExpression, NSException, NSInvalidArgumentException, @"MLNFillExtrusionLayer should raise an exception if a camera-data expression is applied to a property that does not support key paths to feature attributes.");
        functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)", constantExpression, @{@18: constantExpression}];
        functionExpression = [NSExpression expressionWithFormat:@"mgl_interpolate:withCurveType:parameters:stops:($zoomLevel, 'linear', nil, %@)", @{@10: functionExpression}];
        XCTAssertThrowsSpecificNamed(layer.fillExtrusionTranslation = functionExpression, NSException, NSInvalidArgumentException, @"MLNFillExtrusionLayer should raise an exception if a camera-data expression is applied to a property that does not support key paths to feature attributes.");
    }
    ...
    // fill-extrusion-translate-anchor
    {
        ...
        functionExpression = [NSExpression expressionForKeyPath:@"bogus"];
        XCTAssertThrowsSpecificNamed(layer.fillExtrusionTranslationAnchor = functionExpression, NSException, NSInvalidArgumentException, @"MLNFillExtrusionLayer should raise an exception if a camera-data expression is applied to a property that does not support key paths to feature attributes.");
        functionExpression = [NSExpression expressionWithFormat:@"mgl_step:from:stops:(bogus, %@, %@)", constantExpression, @{@18: constantExpression}];
        functionExpression = [NSExpression expressionWithFormat:@"mgl_interpolate:withCurveType:parameters:stops:($zoomLevel, 'linear', nil, %@)", @{@10: functionExpression}];
        XCTAssertThrowsSpecificNamed(layer.fillExtrusionTranslationAnchor = functionExpression, NSException, NSInvalidArgumentException, @"MLNFillExtrusionLayer should raise an exception if a camera-data expression is applied to a property that does not support key paths to feature attributes.");
    }
...
- (void)testValueAdditions {
    XCTAssertEqual([NSValue valueWithMLNFillExtrusionTranslationAnchor:MLNFillExtrusionTranslationAnchorMap].MLNFillExtrusionTranslationAnchorValue, MLNFillExtrusionTranslationAnchorMap);
    XCTAssertEqual([NSValue valueWithMLNFillExtrusionTranslationAnchor:MLNFillExtrusionTranslationAnchorViewport].MLNFillExtrusionTranslationAnchorValue, MLNFillExtrusionTranslationAnchorViewport);
}
